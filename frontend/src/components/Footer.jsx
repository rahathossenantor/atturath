            ...
            <div className="md:container md:mx-auto 2xl:px-0 xl:px-0 lg:px-5 md:px-5 px-5">
                <div>
                    ...
                    <footer className="footer footer-center py-3 text-base-content border-t">
                        <aside>
                            <p className="text-base">Copyright © 2024 - All right reserved | Made by <a className="font-semibold link-hover" href="https://rahathossen.com/" target="_blank" rel="noreferrer">Md Rahat Hossen Antor</a></p>
                        </aside>
                    </footer>
                </div>
            </div>

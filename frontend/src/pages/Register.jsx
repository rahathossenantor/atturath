                            ...
                            <div className="grow p-5 md:px-16 md:py-12">
                                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <input {...register("image", { required: true })} type="file" id="image" className="file-input file-input-bordered w-full focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:border-gray-600 dark:bg-gray-800 dark:placeholder-gray-400 dark:focus:border-blue-500" />
